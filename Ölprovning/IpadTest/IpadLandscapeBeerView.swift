//
//  IpadLandscapeView.swift
//  RememBEER
//
//  Created by Petter Gustafsson on 2023-12-27.
//

import SwiftUI
import CoreData

struct IpadLandscapeBeerView: View {
            ...
            ZStack {
                ...
                VStack(spacing: 20) {
                    ...
                    Button(action: {
                        ...
                        Text("Add beer")
                            .modifier(addButtonColor())
                    })
                    .modifier(addButtonBackgroundColor())
